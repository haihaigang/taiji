        ...
        concat: {
            ...
            allBaseInOne: {
                src: [
                    ...
                    'src/content/js/base_dev/utils.js',
                    'src/content/js/base_dev/utils-date.js',
                    'src/content/js/base_dev/utils-currency.js',
                    'src/content/js/base_dev/utils-browser.js',
                    'src/content/js/base_dev/utils-device.js',
